                        ...
                        <td className="px-6 py-4.5 text-sm font-medium">
                          <div className="flex items-center justify-center gap-3">
                            <Link 
                              ...
                              className="text-cyan-600 hover:text-cyan-800 transition-colors font-semibold"
                            >
                              Edit
                            </Link>
                            <button 
                              onClick={() => booking.id && handleDelete(booking.id)}
                              className="text-rose-500 hover:text-rose-700 transition-colors font-semibold"
                            >
                              Hapus
                            </button>
                          </div>
